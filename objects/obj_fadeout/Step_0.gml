...
if (instance_exists(obj_player))
{
    with (obj_player1)
    {
        if (other.fadein == true && (obj_player1.state == (112 << 0) || obj_player1.state == (98 << 0)) && (sprite_index == spr_victory || place_meeting(x, y, obj_door) || place_meeting(x, y, obj_startgate)))
        {
            state = (95 << 0);
            image_index = 0;
    ...
    if (instance_exists(obj_player2))
    {
        with (obj_player2)
        {
            if (other.fadein == true && (obj_player2.state == (112 << 0) || obj_player2.state == (98 << 0)) && (place_meeting(x, y, obj_door) || place_meeting(x, y, obj_startgate)))
            {
                state = (95 << 0);
                image_index = 0;
            ...
            if (other.fadein == true && obj_player2.state == (112 << 0) && (obj_player2.sprite_index == spr_downpizzabox || obj_player2.sprite_index == spr_uppizzabox))
            {
                state = (101 << 0);
