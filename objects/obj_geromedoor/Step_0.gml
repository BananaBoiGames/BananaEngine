if (!global.horse && (obj_player1.state == (0 << 0) || obj_player1.state == (103 << 0) || obj_player1.state == (58 << 0) || obj_player1.state == (104 << 0) || obj_player1.state == (121 << 0) || obj_player1.state == (99 << 0)) && obj_player1.key_up && obj_player1.grounded && (global.gerome == true || image_index == 1) && place_meeting(x, y, obj_player1))
{
