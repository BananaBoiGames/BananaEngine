...
for (var i = 0; i < 2; i++)
{
    ...
    if (instance_exists(baddieID) && place_meeting(x, y, _obj_player) && _obj_player.cutscene == false)
    {
        if (baddieID.state != (4 << 0) && !baddieID.invincible && baddieID.state != (17 << 0))
        {
            with (_obj_player)
            {
                if (instance_exists(other.baddieID) && y < other.baddieID.y && attacking == false && !global.kungfu && sprite_index != spr_player_mach2jump && ((state == (3 << 0) && vsp > 0) || state == (92 << 0) || state == (103 << 0) || state == (79 << 0)) && vsp > 0 && other.baddieID.vsp >= 0 && sprite_index != spr_stompprep && !other.baddieID.invincible)
                {
                    scr_soundeffect(24);
                    image_index = 0;
                ...
                if (instance_exists(other.baddieID) && other.baddieID.object_index != obj_bigcheese && (state == (5 << 0) || state == (104 << 0)) && other.baddieID.state != (80 << 0) && other.baddieID.state != (137 << 0) && !pepp_grab && other.baddieID.thrown == false && other.baddieID.stuntouchbuffer <= 0 && other.baddieID.state != (4 << 0) && other.baddieID.state != (41 << 0) && other.baddieID.state != (61 << 0) && !other.baddieID.invincible)
                {
                    var lag = 0;
                ...
                {
                    if (instance_exists(other.baddieID) && y < (other.baddieID.y - 50) && attacking == false && state != (42 << 0) && other.baddieID.state != (4 << 0) && sprite_index != spr_player_mach2jump && (state == (92 << 0) || state == (103 << 0) || (state == (79 << 0) && sprite_index != spr_swingding)) && vsp > 0 && other.baddieID.vsp >= 0 && sprite_index != spr_stompprep && !other.baddieID.invincible)
                    {
                        scr_soundeffect(24);
