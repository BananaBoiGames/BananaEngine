with (obj_player1)
{
    if (character != "V")
    {
        if ((place_meeting(x + hsp, y, other) || place_meeting(x + xscale, y, other)) && (obj_player1.state == (121 << 0) || obj_player1.state == (184 << 0) || obj_player1.state == (38 << 0) || obj_player1.state == (153 << 0)))
        {
            playerindex = 0;
