...
with (obj_player1)
{
    if (place_meeting(x, y, other) && key_up && grounded && (state == (0 << 0) || state == (103 << 0) || state == (104 << 0) || state == (121 << 0)) && !instance_exists(obj_noisesatellite) && !instance_exists(obj_fadeout) && state != (98 << 0) && state != (95 << 0) && obj_player1.spotlight == true)
    {
        audio_stop_all();
...
with (obj_player2)
{
    if (place_meeting(x, y, other) && key_up && grounded && (state == (0 << 0) || state == (103 << 0) || state == (104 << 0) || state == (121 << 0)) && !instance_exists(obj_noisesatellite) && !instance_exists(obj_fadeout) && state != (98 << 0) && state != (95 << 0) && obj_player1.spotlight == false)
    {
        audio_stop_all();
        global.leveltosave = other.level;
        backtohubstartx = x;
