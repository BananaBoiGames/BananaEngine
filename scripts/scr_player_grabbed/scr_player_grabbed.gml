...
{
    var _obj_player = (object_index == obj_player2) ? 324 : 323;
    ...
    if (_obj_player.state == (121 << 0) && fightball == true)
    {
        x = _obj_player.x;
        y = _obj_player.y;
    }
    ...
    with (_obj_player)
    {
        ...
        if (!(state == (79 << 0) || (state == (121 << 0) && fightball == true) || (state == (191 << 0) || state == (193 << 0) || state == (192 << 0) || state == (194 << 0)) || state == (6 << 0) || state == (55 << 0) || state == (74 << 0) || state == (75 << 0) || state == (20 << 0) || state == (80 << 0) || state == (76 << 0) || state == (81 << 0) || state == (82 << 0) || state == (83 << 0)))
        {
            baddiegrabbedID = 523;
    ...
    if (_obj_player.state == (191 << 0) || _obj_player.state == (192 << 0))
    {
        visible = false;
        x = _obj_player.x;
        y = _obj_player.y;
